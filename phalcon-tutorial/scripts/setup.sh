...
#
# upgrade php from 7.0 => 7.2
#
echo -e "----------------------------------------"
echo "VAGRANT ==> Upgrade PHP to 7.2"
sudo apt-get install -y php7.2 php7.2-fpm php7.2-cli php7.2-common php7.2-json php7.2-opcache php7.2-mysql php7.2-phpdbg php7.2-mbstring php7.2-gd php-imagick php7.2-pgsql php7.2-pspell php7.2-recode php7.2-tidy php7.2-dev php7.2-intl php7.0-gmp php7.2-curl php7.2-zip php7.2-xml php-memcached mcrypt memcached phpunit
